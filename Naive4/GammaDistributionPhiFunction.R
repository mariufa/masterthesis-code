...
# # alg1pvalue = 0
# # 
# system.time({alg1Results2 = algorithm1Sampling(1000)})
...
#        .combine = rbind) %dopar% {
#          try({
#            result1 = algorithm1Sampling(1000/workers)
#          })
#        }
# })
# stopCluster(cl)
# 
# alg1sampCramer = (as.vector(res))
# #
# cl = makeCluster(detectCores() - 1)
# registerDoParallel(cl, cores = detectCores() - 1)
# workers = 100
...
#                .combine = rbind) %dopar% {
#                  try({
#                    result1 = algorithm2Sampling(1000/workers)
#                  })
#                }
# })
# stopCluster(cl)
# alg2sampCramer = as.vector(res)
# #
...
# #                .combine = rbind) %dopar% {
# #                  try({
# #                    resultstest = testFunction(i)
# #                  })
# #                }
# # })
# # stopCluster(cl)
# # resultstest = as.vector(resultstest)
